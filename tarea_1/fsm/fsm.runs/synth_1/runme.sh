...
HD_PWD='/mnt/shared/Linux/gdrive/usm/2021-s2/ipd432/repo/tarea_1/fsm/fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T1_design1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T1_design1.tcl
